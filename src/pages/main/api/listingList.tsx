...
import { getListingTimeAgo } from "@entities/listing/model/formatTimes";
            ...
            {items.map((product) => (
                ...
                >
                    ...
                    <div className='grow flex flex-col'>
                        ...
                        <p className='text-left'> {getListingTimeAgo(product.meta.createdAt)} | <span className='text-green-500'> rating </span> </p>
